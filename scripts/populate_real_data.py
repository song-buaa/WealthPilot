...
def main():
    ...
    try:
        ...
        positions = [
            ...
            # ── 支付宝 ──
            pos("稳健投资",               "",         "支付宝",   "固收",  "投资", "CNY", 535),
            pos("进取投资",               "",         "支付宝",   "权益",  "投资", "CNY", 460),
            pos("活钱管理",               "",         "支付宝",   "货币",  "投资", "CNY", 199),
            ...
            # ── 招商银行 ──
            pos("活钱管理",        "",      "招商银行", "货币",  "投资", "CNY", 2285),
            pos("稳健投资",        "",      "招商银行", "固收",  "投资", "CNY", 1136),
            pos("进取投资",        "",      "招商银行", "权益",  "投资", "CNY", 698),

            # ── 建设银行（投资部分）──
            pos("基金",            "",      "建设银行", "权益",  "投资", "CNY", 757),
            pos("债券",            "",      "建设银行", "固收",  "投资", "CNY", 103),
            pos("理财产品",        "",      "建设银行", "固收",  "投资", "CNY", 20),
            pos("活钱",            "",      "建设银行", "货币",  "投资", "CNY", 7),
